...
public class JFrameMain extends JFrame {
	...
	private void geometry() throws IOException {
		...
		jPanelControl = new JPanelControl(jPanelTable);
		...
		jtabbed.addTab("Tableau extraction", (new JScrollPane(table)));
		jtabbed.addTab("Hierarchie", (new JScrollPane(test)));
		
		//add(toolBar, BorderLayout.NORTH);
		add(jPanelControl, BorderLayout.WEST);
		add(export, BorderLayout.SOUTH);
		add(jtabbed, BorderLayout.CENTER);
	...
	private void addMenu() {
		...
		menuItem = new JMenuItem("Exporter Csv", KeyEvent.VK_S);
		...
		menuItem = new JMenuItem("Exporter PDF");
